...
echo -e "□ Time Reboot VPS     = 00:00 ${GREEN}( 12 o'Clock Tonight )${NC}"
echo -e "□ License Limit       = 3 VPS ${GREEN}( Limit IP VPS )${NC}"
echo -e "□ AutoScript By Dev   = XDRG ${GREEN}( Ghafoor Ali )${NC}"
